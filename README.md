...
O projeto do primeiro semestre teve como objetivo atender à demanda da empresa parceira fictícia PBLTeX, especializada em cursos e práticas de ensino aplicando PBL (Problem Based Learning). Os requisitos foram apresentados pelos professores das diciplinas que simularam uma empresa real.

A necessidade da empresa era de uma solução computacional para aplicar a técnica de Avaliação 360°, além de possibilitar a análise detalhada dos resultados obtidos pelos alunos e instrutores.  

Como solução, minha equipe desenvolveu uma plataforma desktop que realiza Avaliações 360° e que fornece funcionalidades analíticas para visualização, interpretação dos dados e relatórios.
...
- **Desenvolvimento Back-End**:  
  - Criação de classes, funções e serviçoes utilizando **Java** para implementar as funcionalidades principais do sistema, como controle de horas extras e gestão de usuários.  
...
* **Desenvolvimento de testes unitários e de integração** para garantir a confiabilidade e consistência do sistema.
...
* **Java** - Uso com autonomia para o desenvolvimento de funcionalidades no back-end.
* **Spring Boot** - Uso com ajuda para a criação da API rest utilizada pelo frontend.
...
* **TypeScript** - Linguagem front-end utilizada para tipagem estática e maior segurança no desenvolvimento do front-end.
...
* **Java com Spring Boot** - Uso com autonomia para o desenvolvimento de APIs no back-end.
* **Docker** - Uso com ajuda para a containerização da aplicação.
